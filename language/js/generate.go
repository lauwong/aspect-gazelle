...
import (
	...
	gazelle "github.com/aspect-build/orion/common"
	"github.com/aspect-build/orion/common/cache"
	BazelLog "github.com/aspect-build/orion/common/logger"
	starlark "github.com/aspect-build/orion/common/starlark"
	node "github.com/aspect-build/orion/language/js/node"
	parser "github.com/aspect-build/orion/language/js/parser"
	pnpm "github.com/aspect-build/orion/language/js/pnpm"
	proto "github.com/aspect-build/orion/language/js/proto"
