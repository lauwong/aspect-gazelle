...
func (c *clientFactory) New(aspectplugin loader.AspectPlugin, streams ioutils.Streams) (*PluginInstance, error) {
	...
	if strings.Contains(aspectplugin.From, "/") {
		...
		// Example release URL:
		//   from:          https://static.github.com/aspect-build/silo/cli/core
		//   versioned url: https://static.github.com/aspect-build/silo/cli/core/v0.9.0/plugin-aspect-pro-darwin_amd64
