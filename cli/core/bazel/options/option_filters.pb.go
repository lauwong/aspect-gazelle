...
const file_cli_core_bazel_options_option_filters_proto_rawDesc = "" +
	"\n" +
	"+cli/core/bazel/options/option_filters.proto\x12\aoptions*\xea\x02\n" +
...
var (
	...
	file_cli_core_bazel_options_option_filters_proto_rawDescData []byte
)
...
func file_cli_core_bazel_options_option_filters_proto_rawDescGZIP() []byte {
	file_cli_core_bazel_options_option_filters_proto_rawDescOnce.Do(func() {
		file_cli_core_bazel_options_option_filters_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cli_core_bazel_options_option_filters_proto_rawDesc), len(file_cli_core_bazel_options_option_filters_proto_rawDesc)))
	})
...
var file_cli_core_bazel_options_option_filters_proto_goTypes = []any{
...
func file_cli_core_bazel_options_option_filters_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cli_core_bazel_options_option_filters_proto_rawDesc), len(file_cli_core_bazel_options_option_filters_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
