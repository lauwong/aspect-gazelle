...
const file_cli_core_bazel_command_line_command_line_proto_rawDesc = "" +
	"\n" +
	".cli/core/bazel/command_line/command_line.proto\x12\fcommand_line\x1a+cli/core/bazel/options/option_filters.proto\"y\n" +
	"\vCommandLine\x12,\n" +
...
var (
	...
	file_cli_core_bazel_command_line_command_line_proto_rawDescData []byte
)
...
func file_cli_core_bazel_command_line_command_line_proto_rawDescGZIP() []byte {
	file_cli_core_bazel_command_line_command_line_proto_rawDescOnce.Do(func() {
		file_cli_core_bazel_command_line_command_line_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cli_core_bazel_command_line_command_line_proto_rawDesc), len(file_cli_core_bazel_command_line_command_line_proto_rawDesc)))
	})
...
var file_cli_core_bazel_command_line_command_line_proto_goTypes = []any{
...
func file_cli_core_bazel_command_line_command_line_proto_init() {
	...
	file_cli_core_bazel_command_line_command_line_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cli_core_bazel_command_line_command_line_proto_rawDesc), len(file_cli_core_bazel_command_line_command_line_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
