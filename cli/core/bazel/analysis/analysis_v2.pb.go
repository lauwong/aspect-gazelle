...
const file_cli_core_bazel_analysis_analysis_v2_proto_rawDesc = "" +
	"\n" +
	")cli/core/bazel/analysis/analysis_v2.proto\x12\x05bazel\x1a cli/core/bazel/query/build.proto\"\xcb\x03\n" +
...
var (
	...
	file_cli_core_bazel_analysis_analysis_v2_proto_rawDescData []byte
)
...
func file_cli_core_bazel_analysis_analysis_v2_proto_rawDescGZIP() []byte {
	file_cli_core_bazel_analysis_analysis_v2_proto_rawDescOnce.Do(func() {
		file_cli_core_bazel_analysis_analysis_v2_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cli_core_bazel_analysis_analysis_v2_proto_rawDesc), len(file_cli_core_bazel_analysis_analysis_v2_proto_rawDesc)))
	})
...
var file_cli_core_bazel_analysis_analysis_v2_proto_goTypes = []any{
...
func file_cli_core_bazel_analysis_analysis_v2_proto_init() {
	...
	file_cli_core_bazel_analysis_analysis_v2_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cli_core_bazel_analysis_analysis_v2_proto_rawDesc), len(file_cli_core_bazel_analysis_analysis_v2_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   0,
