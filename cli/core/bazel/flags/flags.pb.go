...
const file_cli_core_bazel_flags_flags_proto_rawDesc = "" +
	"\n" +
	" cli/core/bazel/flags/flags.proto\x12\x05bazel\"\x8b\x03\n" +
	"\bFlagInfo\x12\x12\n" +
...
var (
	...
	file_cli_core_bazel_flags_flags_proto_rawDescData []byte
)

func file_cli_core_bazel_flags_flags_proto_rawDescGZIP() []byte {
	file_cli_core_bazel_flags_flags_proto_rawDescOnce.Do(func() {
		file_cli_core_bazel_flags_flags_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cli_core_bazel_flags_flags_proto_rawDesc), len(file_cli_core_bazel_flags_flags_proto_rawDesc)))
	})
...
var file_cli_core_bazel_flags_flags_proto_goTypes = []any{
...
func file_cli_core_bazel_flags_flags_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cli_core_bazel_flags_flags_proto_rawDesc), len(file_cli_core_bazel_flags_flags_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
