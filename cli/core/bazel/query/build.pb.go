...
const file_cli_core_bazel_query_build_proto_rawDesc = "" +
	"\n" +
	" cli/core/bazel/query/build.proto\x12\x19blaze_query_aspect_mirror\"J\n" +
	"\aLicense\x12!\n" +
...
var (
	...
	file_cli_core_bazel_query_build_proto_rawDescData []byte
)

func file_cli_core_bazel_query_build_proto_rawDescGZIP() []byte {
	file_cli_core_bazel_query_build_proto_rawDescOnce.Do(func() {
		file_cli_core_bazel_query_build_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cli_core_bazel_query_build_proto_rawDesc), len(file_cli_core_bazel_query_build_proto_rawDesc)))
	})
...
var file_cli_core_bazel_query_build_proto_goTypes = []any{
...
func file_cli_core_bazel_query_build_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cli_core_bazel_query_build_proto_rawDesc), len(file_cli_core_bazel_query_build_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   26,
			NumExtensions: 0,
			NumServices:   0,
