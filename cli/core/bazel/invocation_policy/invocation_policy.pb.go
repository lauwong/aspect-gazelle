...
const file_cli_core_bazel_invocation_policy_invocation_policy_proto_rawDesc = "" +
	"\n" +
	"8cli/core/bazel/invocation_policy/invocation_policy.proto\x12\x11invocation_policy\"V\n" +
...
var (
	...
	file_cli_core_bazel_invocation_policy_invocation_policy_proto_rawDescData []byte
)
...
func file_cli_core_bazel_invocation_policy_invocation_policy_proto_rawDescGZIP() []byte {
	file_cli_core_bazel_invocation_policy_invocation_policy_proto_rawDescOnce.Do(func() {
		file_cli_core_bazel_invocation_policy_invocation_policy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cli_core_bazel_invocation_policy_invocation_policy_proto_rawDesc), len(file_cli_core_bazel_invocation_policy_invocation_policy_proto_rawDesc)))
	})
...
var file_cli_core_bazel_invocation_policy_invocation_policy_proto_goTypes = []any{
...
func file_cli_core_bazel_invocation_policy_invocation_policy_proto_init() {
	...
	file_cli_core_bazel_invocation_policy_invocation_policy_proto_msgTypes[1].OneofWrappers = []any{
		(*FlagPolicy_SetValue)(nil),
		(*FlagPolicy_UseDefault)(nil),
		(*FlagPolicy_DisallowValues)(nil),
		(*FlagPolicy_AllowValues)(nil),
	}
	file_cli_core_bazel_invocation_policy_invocation_policy_proto_msgTypes[4].OneofWrappers = []any{
		(*DisallowValues_NewValue)(nil),
		(*DisallowValues_UseDefault)(nil),
	}
	file_cli_core_bazel_invocation_policy_invocation_policy_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cli_core_bazel_invocation_policy_invocation_policy_proto_rawDesc), len(file_cli_core_bazel_invocation_policy_invocation_policy_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
