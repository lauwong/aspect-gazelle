...
const file_cli_core_bazel_failure_details_failure_details_proto_rawDesc = "" +
	"\n" +
	"4cli/core/bazel/failure_details/failure_details.proto\x12\x0ffailure_details\x1a google/protobuf/descriptor.proto\"4\n" +
...
var (
	...
	file_cli_core_bazel_failure_details_failure_details_proto_rawDescData []byte
)
...
func file_cli_core_bazel_failure_details_failure_details_proto_rawDescGZIP() []byte {
	file_cli_core_bazel_failure_details_failure_details_proto_rawDescOnce.Do(func() {
		file_cli_core_bazel_failure_details_failure_details_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cli_core_bazel_failure_details_failure_details_proto_rawDesc), len(file_cli_core_bazel_failure_details_failure_details_proto_rawDesc)))
	})
...
var file_cli_core_bazel_failure_details_failure_details_proto_goTypes = []any{
...
func file_cli_core_bazel_failure_details_failure_details_proto_init() {
	...
	file_cli_core_bazel_failure_details_failure_details_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cli_core_bazel_failure_details_failure_details_proto_rawDesc), len(file_cli_core_bazel_failure_details_failure_details_proto_rawDesc)),
			NumEnums:      63,
			NumMessages:   66,
			NumExtensions: 1,
			NumServices:   0,
