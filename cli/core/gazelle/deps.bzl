...
load("//cli/core/gazelle/common/treesitter/grammars:grammars.bzl", _fetch_grammars = "fetch_grammars")

def fetch_gazelle():
    http_archive(
        name = "bazel_gazelle",
        sha256 = "fa1a981ae546684dbb7e7f428bafe0180530af09eace265094e03f4383fc0de4",
        strip_prefix = "bazel-gazelle-186298911d38850b47b198e8d933a93125ce7043",
